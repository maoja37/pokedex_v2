...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<PokemonEntity> pokemons) : _pokemons = pokemons;
...
abstract class _Loaded implements PokemonState {
  const factory _Loaded(final List<PokemonEntity> pokemons) = _$LoadedImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'PokemonState.error(failure: $failure)';
  }
